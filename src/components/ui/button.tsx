...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 hover:scale-[1.03] active:scale-[0.97] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-[#7b39fc] text-white ring-1 ring-white/15 shadow-[0_10px_30px_-8px_rgba(123,57,252,0.7)] hover:bg-[#8c4cff] hover:shadow-[0_14px_36px_-8px_rgba(123,57,252,0.95)]",
        primary:
          "bg-[#7b39fc] text-white ring-1 ring-white/15 shadow-[0_10px_30px_-8px_rgba(123,57,252,0.7)] hover:bg-[#8c4cff] hover:shadow-[0_14px_36px_-8px_rgba(123,57,252,0.95)]",
        outline:
        ...
        danger: "border border-red-500/30 bg-red-500/20 text-red-300 hover:bg-red-500/30",
